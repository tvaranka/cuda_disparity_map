...
__global__
void disparity_map2(unsigned char* img0, unsigned char* img1, unsigned char* disp_img0,
...
int main() {
	...
	cv::Mat img0 = cv::imread("../im0small.png", cv::IMREAD_GRAYSCALE);
	cv::Mat img1 = cv::imread("../im1small.png", cv::IMREAD_GRAYSCALE);
	...
	//disparity_map2<<<grid, block>>>(d_img0, d_img1, d_disp_img0, d_disp_img1, width, height);
